...
class RegistrationDriverAndPassengerFinal : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        receivedRegisterStepTwoData = Gson().fromJson<MutableMap<String, String>>(
            receivedRegisterStepTwoJson,
            typeReceivedRegisterStepTwoJson
        )
        receivedRegisterStepTwoImages = Gson().fromJson<MutableList<ImageDocument>>(
            registerStepTwoImagesJson,
            typeRegisterStepTwoImagesJson
        )
        ...
        val completeRegistrationButton: Button =
            findViewById<Button>(R.id.completeRegistrationButton)
        ...
        completeRegistrationButton.setOnClickListener {
            ...
            if (!acceptCheckBox.isChecked) {
                ...
                AlertDialog.Builder(this)
                    ...
                    .setMessage("You must accept Terms and Conditions to use the app.")
                    .setCancelable(false)
                ...
                ApiClient.retrofit.registerUser(Gson().toJson(receivedRegisterStepTwoData))
                ...
                ApiClient.retrofit.uploadImage(receivedRegisterStepTwoImages[0])
                    .enqueue(object : Callback<String> {
                        override fun onResponse(call: Call<String>, response: Response<String>) {
                            if (response.isSuccessful) {
                ...
                ApiClient.retrofit.uploadImage(receivedRegisterStepTwoImages[1])
                    .enqueue(object : Callback<String> {
                        override fun onResponse(call: Call<String>, response: Response<String>) {
                            if (response.isSuccessful) {
                ...
                ApiClient.retrofit.uploadImage(receivedRegisterStepTwoImages[2])
                    .enqueue(object : Callback<String> {
                        override fun onResponse(call: Call<String>, response: Response<String>) {
                            if (response.isSuccessful) {
                ...
                ApiClient.retrofit.uploadImage(receivedRegisterStepTwoImages[3])
                    .enqueue(object : Callback<String> {
                        override fun onResponse(call: Call<String>, response: Response<String>) {
                            if (response.isSuccessful) {
                ...
                ApiClient.retrofit.uploadImage(receivedRegisterStepTwoImages[4])
                    .enqueue(object : Callback<String> {
                        override fun onResponse(call: Call<String>, response: Response<String>) {
                            if (response.isSuccessful) {
    ...
    private fun callCreateKorisnikImage() {
        ...
        for (item in createdImages) {
            ...
            ApiClient.retrofit.createKorisnikImage(korisnikImage)
        ...
        val intent =
            Intent(this@RegistrationDriverAndPassengerFinal, RegisterPendingScreen::class.java)
        ...
        imageCapture.takePicture(
            ...
            object : ImageCapture.OnImageSavedCallback {
                override fun onImageSaved(outputFileResults: ImageCapture.OutputFileResults) {
                    ...
                    selfieBase64 =
                        selfieUri?.let { uriToBase64(this@RegistrationDriverAndPassengerFinal, it) }

                    receivedRegisterStepTwoImages.add(
                        ImageDocument(
                            "Selfie",
                            selfieBase64.toString(),
                            3
                        )
                    )
                }
    ...
    private fun showTermsAndConditions() {
        ...
        We are OICAR
        We operate 
        the mobile application CARSHARE(the "App"), as well as any other related products and services that refer or link to these legal terms (the "Legal Terms") (collectively, the "Services").You can contact us by phone at +385 98 654 1278, email at
        oicarproject@gmail.com.
        
        These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity ("you"), and OICAR, concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.
        ...
        oicarproject@gmail.com, as stated in the email message. By continuing to use the Services after the effective date of any changes, you agree to be bound by the modified terms.
        ...
        val view = inflater.inflate(R.layout.terms_and_conditions, null)

        val textTerms: TextView = view.findViewById<TextView>(R.id.terms_text)
        textTerms.text = termsText
